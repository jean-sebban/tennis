...
## 2- 5 ajout d'informations à partir des stats matches
...
## 2-7 Mise en forme finale de la base
...
saveRDS(don_clustering,"don_clustering.rds")
...
Test avec une validation croisée à 10 blocs sur les données d'entraîenement. Les résultats des différents algorithmes seront stockés dans le dataframe RES.
