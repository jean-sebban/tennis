...
6.  Une regression ridge, avec deux lambda différents

7.  Une regression lasso avec deux lambda différents

8.  Une regression elastic net avec deux lambda différents
