...
don_with_stats <- don_with_stats %>% 
  ...
  mutate(avg_nb_ace_last_3 = test(x=aces, N=3)) %>%
...
rm(don_loser,don_pivotted,don_winner,don_with_stats,loser_stats,match_player_stats,winner_stats)
...
tmp <- don %>% 
  ...
  left_join(tournois[,c("tourney_url_suffix","tourney_surface")],by="tourney_url_suffix") %>% 
