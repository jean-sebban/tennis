...
#attention : programme assez long à tourner
...
Le modèle retenu est donc la random forest. On la recalcule sur tout le fichier d'entraînement (en prenant en compte les 3 années du fichier de validation).
